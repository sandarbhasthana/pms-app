...
async function testMigration() {
  ...
  try {
    ...
    console.log(`   ✅ ${roomTypesWithProperty}/${roomTypeCount} room types have propertyId`);
    ...
    console.log(`   ✅ ${roomsWithProperty}/${roomCount} rooms have propertyId`);
    ...
    console.log(`   ✅ ${reservationsWithProperty}/${reservationCount} reservations have propertyId`);
