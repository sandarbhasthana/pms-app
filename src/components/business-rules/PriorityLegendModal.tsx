      ...
      <div className="flex items-center justify-center min-h-screen bg-black/60 p-4">
        <Dialog.Panel className="relative w-full max-w-2xl bg-white dark:bg-gray-900 rounded-lg p-6 text-sm text-gray-900 dark:text-white max-h-[90vh] overflow-y-auto">
          <button
            type="button"
            onClick={onClose}
            className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center rounded-lg text-gray-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
          >
            ×
          </button>
          ...
          <div className="bg-white dark:bg-[#1e1e1e] rounded-lg p-4 border border-gray-300 dark:border-gray-700">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-3">
              How Priority Works
            </h3>
            <ul className="text-sm text-gray-700 dark:!text-gray-100 space-y-2">
              <li>
                • Rules execute in <strong>priority order</strong> (lowest
                number first)
              </li>
              <li>
