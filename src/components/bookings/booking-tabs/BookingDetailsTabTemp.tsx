...
interface BookingDetailsTabTempProps extends BookingTabProps {
  showScanner: boolean;
...
export const BookingDetailsTabTemp: React.FC<BookingDetailsTabTempProps> = ({
  formData,
  updateFormData,
  selectedSlot,
  onNext,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
        ...
        {/* Payment Summary Bar */}
        <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 border border-purple-200 dark:border-purple-700 mt-6">
            ...
            <div>
              ...
              <p className="text-lg font-semibold">
                ...
                {(() => {
                  ...
                  return (2500 * nights).toLocaleString();
                })()}{" "}
            ...
            <div className="text-right">
              ...
              <p className="text-lg font-semibold text-purple-600">
                ...
                {(() => {
                  ...
                  return Math.max(total * 0.3, 1000).toLocaleString();
                })()}
              </p>
            </div>
          </div>
