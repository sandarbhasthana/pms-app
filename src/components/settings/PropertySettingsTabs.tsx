    ...
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-2 bg-transparent p-0 h-auto gap-3 mb-6">
          <TabsTrigger
            value="general"
            className="data-[state=active]:bg-[#7210a2] data-[state=active]:text-white hover:bg-[#8b2fc9] hover:text-white bg-muted text-foreground/70 px-6 py-3 rounded-full text-sm font-medium transition-all duration-200 shadow-sm"
          >
            General
          </TabsTrigger>
          <TabsTrigger
